...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajuda no caso "${incident.title}" cam o valor de R$ ${Intl.NumberFormat(
        'pt-BR',
        {
            style: 'currency',
            currency: 'BRL'
    ...
    function sendEmail() {
        MailComposer.composeAsync({
            subject: `Herói da vez: ${incident.title}`,
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.incidents}>
                ...
                <Text style={styles.incidentsValue}>{Intl.NumberFormat(
                    'pt-BR',
                    {
                        style: 'currency',
                        currency: 'BRL'
